...
export class VoitureService {
  ...
  getvoiturebynumero(numero) {
    return this.http.get(base_url + `api/voitures/atelier/${numero}`, this.authService.option(true));
  }


  updatevoiture(numero, body) {
    return this.http.put(base_url + `api/voitures/client/${numero}/update`, body,  this.authService.option(true));
  }


  recuperervoiture(numero) {
    return this.http.post(base_url + `api/voitures/client/recuperer/${numero}`, null,  this.authService.option(true));
  }
